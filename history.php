    ...
    <?php
     ...
     if($num > 0){
        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<tr>";
            echo "<td>" . $row["sender"]. "</td><td>". $row["sen_acc"]. "</td><td>" . $row["receiver"] . "</td><td>" . $row["rec_acc"] . "</td><td>"  . $row["amount"] . "</td><td>"  . $row["created_on"]."</td>";
            echo "</tr>";
            }
 ...
 <nav id="sideNav">
    ...
    <div class="follow">
      ...
      <div class="social">
        ...
        <a href="https://www.linkedin.com/in/aryamann-sinha-11399b192/" class="linkedin">
    ...
    <p class="text-copy">
      Copyright &copy; 2021 Made by <b>Aryamann Sinha</b> <br> For the Project of  <b>The Sparks Foundation</b>
    </p>
</footer>
    <script>
